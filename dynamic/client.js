        ...
        ctx.slots.inject('settings.section', () => ctx.slots.register(
          ...
          () => {
            ...
            return React.createElement('div', { className: 'dsh-comp-page', onDragOver: (e) => e.preventDefault() },
              ...
              React.createElement('div', { className: 'dsh-fullusage', style: { display: 'flex', flexDirection: 'column', padding: '6px 8px', borderRadius: 6, background: 'var(--dsw-alias-interactive-bg-hover)', fontSize: 12, lineHeight: '16px', color: 'var(--dsw-alias-label-secondary)' } },
