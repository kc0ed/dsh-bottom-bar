      ...
      ctx.slots.inject('settings.section', () => ctx.slots.register(
        ...
        () => {
          ...
          const updatePrice = (model, patch) => {
            ...
            host.call('set-price', { model, price: {
          ...
          const addPrice = () => {
            ...
            setNewModel('')
            setNewIn('')
            host.call('set-price', { model: id, price: {
              currency: 'USD',
              in: inPrice,
