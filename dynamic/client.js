          ...
          () => {
            ...
            const makeLineChildren = () => {
              ...
              previewSegs.forEach((item, i) => {
                if (i > 0) {
                  children.push(React.createElement('span', { className: 'dsh-stats-sep', 'aria-hidden': true, key: 'ps_sep_' + i }, '|'))
                }
                children.push(React.createElement('span', {
            ...
            return React.createElement('div', { className: 'dsh-comp-page', onDragOver: (e) => e.preventDefault() },
              ...
              React.createElement('p', { className: 'dsh-comp-desc' }, '配置输入框下方的底栏统计行。按住 Ctrl 可多选分段批量拖拽排序；开关组：显示/隐藏、输入缓存口径、黑条行为、费用精度；价格表在页面底部（折叠）。'),
