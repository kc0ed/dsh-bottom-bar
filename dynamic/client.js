    ...
    async apply(ctx) {
      ...
      const remote = (remoteRaw !== null && remoteRaw !== undefined && typeof Proxy !== 'undefined')
        ...
        styles.insert('.dsh-comp-page{display:flex;flex-direction:column;gap:10px;padding:6px 0;font-size:13px;line-height:20px;color' +
            ...
            'preview-bubble{align-self:center;max-width:100%;padding:3px 7px;border-radius:8px;border:1px solid var(--dsw-' +
            'alias-border-l2);background:var(--dsw-alias-bg-layer-2);color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px;white-space:nowrap;overfl' +
