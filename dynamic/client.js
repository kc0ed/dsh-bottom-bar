...
.dsh-preview-hl {
  ...
  box-shadow: 0 0 12px rgba(193, 95, 60, 0.50), 0 2px 6px rgba(193, 95, 60, 0.35) !important;
}
body[data-ds-dark-theme] .dsh-preview-hl {
  background: #D97757 !important;
  border-color: #D97757 !important;
  box-shadow: 0 0 14px rgba(217, 119, 87, 0.60), 0 2px 8px rgba(217, 119, 87, 0.40) !important;
}
.dsh-preview-ghost {
...
.dsh-preview-ghost-enter {
  animation: dsh-ghost-grow 0.34s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
}
.dsh-preview-ghost-exit {
  animation: dsh-ghost-shrink 0.28s cubic-bezier(0.4, 0, 0.2, 1) forwards;
}
.dsh-ghost-sep-enter {
  animation: dsh-ghost-sep-grow 0.34s cubic-bezier(0.34, 1.56, 0.64, 1) forwards;
  overflow: hidden;
  white-space: nowrap;
  vertical-align: middle;
}
.dsh-ghost-sep-exit {
  animation: dsh-ghost-sep-shrink 0.28s cubic-bezier(0.4, 0, 0.2, 1) forwards;
  overflow: hidden;
  white-space: nowrap;
  vertical-align: middle;
}
...
.dsh-comp-row.dsh-row-hovered {
  ...
  box-shadow: inset 0 0 0 1px rgba(193, 95, 60, 0.40), 0 0 16px rgba(193, 95, 60, 0.22), 0 4px 18px rgba(193, 95, 60, 0.15) !important;
  transform: none !important;
}
body[data-ds-dark-theme] .dsh-comp-row.dsh-row-hovered {
  border-color: #D97757 !important;
  box-shadow: inset 0 0 0 1px rgba(217, 119, 87, 0.50), 0 0 18px rgba(217, 119, 87, 0.32), 0 4px 22px rgba(217, 119, 87, 0.22) !important;
  transform: none !important;
}
              ...
              React.createElement('div', { className: 'dsh-preview' },
                ...
                previewSegs.length === 0
                  ...
                  : React.createElement('div', {
                      ...
                      ref: previewDockRef,
                      title: previewSegs.map((s) => s.text).join(' | '),
                      onWheel: (e) => {
