...
// ── 峰谷定价时段（DeepSeek 2026-08-17 起 · 北京时间,UTC+8 无夏令时） ──
...
export function resolvePrice(model, configPrices, opts) {
  ...
  if (opts !== undefined && opts.peakEnabled === true && providersOk && peakSet !== undefined && isPeakTime(opts.when)) {
    merged = {
