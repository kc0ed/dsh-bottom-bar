...
class BottomBarService extends TypertRemoteService {
  ...
  priceOf(model) {
    ...
    const user = this.configPrices === null || this.configPrices === undefined ? undefined
      : (this.configPrices[model] !== undefined ? this.configPrices[model] : this.configPrices[modelPart])
