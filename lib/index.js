...
const DEFAULT_PRICES = {
  ...
  'claude-4-5-haiku': { currency: 'USD', in: 0.8, cacheRead: 0.08, cacheWrite: 1, out: 4 },
  'claude-3-opus': { currency: 'USD', in: 15, cacheRead: 1.5, cacheWrite: 18.75, out: 75 },
  'claude-4-opus': { currency: 'USD', in: 15, cacheRead: 1.5, cacheWrite: 18.75, out: 75 },
  ...
  // Kimi / 月之暗面（CNY / 1M tokens）
  'kimi-k2': { currency: 'CNY', in: 4, cacheRead: 1, cacheWrite: 4, out: 16 },
  'kimi-k2-5': { currency: 'CNY', in: 4, cacheRead: 1, cacheWrite: 4, out: 16 },
  'kimi-k2-7-code': { currency: 'CNY', in: 6, cacheRead: 1.2, cacheWrite: 6, out: 25 },

  // 智谱 GLM / MiniMax（CNY / 1M tokens）
  'glm-4': { currency: 'CNY', in: 5, cacheRead: 1, cacheWrite: 5, out: 15 },
  'glm-5': { currency: 'CNY', in: 8, cacheRead: 1.6, cacheWrite: 8, out: 28 },
