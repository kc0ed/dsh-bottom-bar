...
class BottomBarService extends TypertRemoteService {
  ...
  async estimateCost(args) {
    ...
    try {
      ...
      est.peak = { enabled: this.peakRemind, priced: this.peakEnabled && anyOfficial, window: peakNow, tz: this.peakTimezone, baseIn, baseRead, baseOut, peakIn, peakRead, peakOut }
      return est
    } catch (err) {
