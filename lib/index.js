...
class BottomBarService extends TypertRemoteService {
  ...
  summaryAll() {
    ...
    for (const u of used) {
      ...
      rows.push({ key: u.key, provider: u.provider, model: u.model, tokens: u.tokens, cost, currency, source, free: isFree, refCost, refCurrency, uncachedInput: u.uncachedInput, cacheRead: u.cacheRead, cacheWrite: u.cacheWrite, output: u.output, inCost, cacheReadCost, cacheWriteCost, outCost, peakShare, idleCost: dual !== null ? dual.idleCost : 0, peakCost: dual !== null ? dual.peakCost : 0 })
    }
