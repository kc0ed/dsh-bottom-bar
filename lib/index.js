...
class BottomBarService extends TypertRemoteService {
  ...
  async estimateCost(args) {
    ...
    try {
      ...
      est.peak = { enabled: this.peakRemind, priced: this.peakEnabled && anyOfficial, billing: this.peakEnabled, window: peakNow, tz: this.peakTimezone, baseIn, baseRead, baseOut, peakIn, peakRead, peakOut, models: this.peakModelList() }
      return est
    } catch (err) {
