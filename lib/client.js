...
// 修订 70（client）：预览区强调色与品牌色解耦——默认主题下 brand-primary 是
// 黑色,预览高亮变黑底白字对比过强（用户：改成灰色,不要太黑）。新增局部变量
// --dsh-preview-accent:#6B6B6B（定义在 .dsh-comp-page）,预览区 hover/高亮/幽灵
// 分段全部改用它 + color-mix 派生透明;列表行选中、徽章、多选条仍走品牌色。
// ══════════════════════════════════════════════════════════════════
